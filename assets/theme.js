  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _updateAddToCart: function(evt) {
      ...
      if (variant) { 
        ...
        } else if (variant.inventory_policy == 'deny' && variant.available =='false' ) { 
         ...
         else if (variant.available =='false' && variant.inventory_policy == 'continue') { 
          this.addToCart.removeAttribute('aria-disabled');
          this.addToCart.setAttribute('aria-label', theme.strings.PreOrder);
          addToCartText.innerHTML = theme.strings.PreOrder;
          productForm.classList.remove(this.classes.variantaddToCart);
        }
      } else { 
